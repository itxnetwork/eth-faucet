...
var (
	...
	payoutFlag   = flag.Int("faucet.amount", 1, "Number of ITX to transfer per user request")
	...
	symbolFlag   = flag.String("faucet.symbol", "ITX", "Token symbol to display on the frontend")
